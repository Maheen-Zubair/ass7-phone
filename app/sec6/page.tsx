...
import image from "../public/Iphone 14 pro (2).png"
...
export default function Section6() {
    return (
        <div>
            <div className="w-full h-[656px] bg-white flex flex-col justify-center items-center">
                <div className="first-container flex pt-16 gap-10 h-[32px] w-[1120px]  mb-[32px] ">

                    <h4 className=" font-medium text-[24px] text-black ">Discounts up to -50%</h4>

                </div>

                <div className="second-container h-[880px] w-[1120px] flex justify-between items-center  ">
                    ...
                    <div className="w-[268px] h-[432px] bg-customF6F6F6 flex flex-col gap-8">
                        ...
                        <div className="flex flex-col justify-center items-center gap-3">
                            ...
                            <div className="flex flex-col justify-center items-center text-center w-[236px] h-[160px] gap-2">
                                ...
                                <div className="font-semibold text-[24px]">$1437</div>
                    ...
                    <div className="w-[268px] h-[432px] bg-customF6F6F6 flex flex-col gap-8">
                        ...
                        <div className="flex flex-col justify-center items-center gap-3">
                            ...
                            <div className="flex flex-col justify-center items-center text-center w-[236px] h-[160px] gap-2">
                                <div className="font-medium text-[16px] ml-5 mr-5 ">Apple iPhone 14 Pro Max 128GB Deep Purple </div>
                                <div className="font-semibold text-[24px]">$149</div>
                                <button className="w-[188px] h-[48px] rounded-[8px] bg-black font-medium text-[14px] text-white  hover:bg-white border-[1px] hover:border-black  hover:text-black  duration-300 ease-in-out">Buy Now</button>
                            </div>
                        </div>
                    </div>
